    ...
    <div class="main-wrapper bg-gray-50 min-h-screen pb-20">
        <main class="content-area max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            @else
                ...
                {{-- Simple Header --}}
                <div class="mb-8">
                     <a href="{{ url()->previous() }}" class="inline-flex items-center gap-2 text-gray-500 hover:text-gray-900 transition-colors">
                ...
                <div class="flex flex-col items-center justify-center min-h-[60vh] py-12">
                    <div class="bg-white p-10 rounded-3xl shadow-sm border border-gray-100 max-w-lg w-full text-center relative overflow-hidden">
                        ...
                        <div class="relative z-10">
                            ...
                            <p class="text-gray-500 mb-8 leading-relaxed">
                                Anda belum memiliki kamar yang disewa saat ini. Silakan cari kamar yang cocok untuk Anda dan lakukan pemesanan.
                            </p>

                            {{-- Asumsi Anda punya route bernama 'rooms.index' atau sejenisnya --}}
                            {{-- Ganti '#' dengan route yang sesuai --}}
                            <a href="{{ route('home') }}" class="inline-flex items-center justify-center gap-3 bg-gray-900 hover:bg-black text-white px-8 py-3.5 rounded-xl font-bold transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 w-full sm:w-auto">
