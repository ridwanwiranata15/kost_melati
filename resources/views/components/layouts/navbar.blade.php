<header class="h-16 flex items-center justify-between px-0 md:px-6 bg-white dark:bg-dark-card border-b border-gray-200 dark:border-gray-700 sticky top-0 z-30">
    ...
    <div class="flex items-center gap-2 sm:gap-3 pr-4 md:pr-0 ml-auto">
        ...
        <button onclick="toggleDarkMode()"
                class="flex items-center justify-center w-9 h-9 rounded-lg text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
                title="Ganti Tema">
        ...
        <div class="relative" x-data="{ open: false }">
            <button @click="open = !open" @click.outside="open = false"
                ...
                {{-- Avatar --}}
                <div class="flex h-8 w-8 items-center justify-center rounded-full bg-primary-500 text-white text-xs font-bold flex-shrink-0">
                ...
                <i class="fas fa-chevron-down text-[10px] text-gray-400 hidden sm:block transition-transform duration-200" :class="{'rotate-180': open}"></i>
            </button>
            ...
            <div x-show="open"
                ...
                <div class="px-4 py-3 border-b border-gray-100 dark:border-gray-700">
                    <p class="text-sm font-semibold text-gray-800 dark:text-white truncate">{{ $user->name ?? 'User' }}</p>
