<div x-data="{ sidebarOpen: false }" class="flex h-screen overflow-hidden bg-gray-100 dark:bg-dark-bg">
    ...
    <div x-show="sidebarOpen"
         ...
         class="fixed inset-0 bg-gray-900/50 z-40 md:hidden glass">
    </div>
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <div class="h-16 flex items-center justify-between px-6 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center">
                ...
                {{-- REVISI: Teks Kost Asri hilang di mobile (hidden), muncul di desktop (md:block) --}}
                <span class="text-xl font-bold text-primary-700 dark:text-primary-500 hidden md:block">Kost Asri</span>
            </div>
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="h-16 flex items-center justify-between px-6 bg-white dark:bg-dark-card border-b border-gray-200 dark:border-gray-700">

            <button @click="sidebarOpen = true" class="text-gray-500 hover:text-primary-600 md:hidden focus:outline-none">
